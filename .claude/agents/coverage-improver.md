...
1. Run `uv run pytest --cov mutt_oauth2 --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov mutt_oauth2 --cov-branch --cov-report term-missing:skip-covered`
