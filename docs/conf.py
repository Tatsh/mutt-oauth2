...
html_theme_options = {
    ...
    'repo_name': 'mutt-oauth2',
    'repo_url': 'https://github.com/Tatsh/mutt-oauth2',
    'site_url': 'https://mutt-oauth2.readthedocs.org',
    'toc_title_is_page_title': True
}
intersphinx_mapping = {
    'aiosmtplib': ('https://aiosmtplib.readthedocs.io/en/stable/', None),
